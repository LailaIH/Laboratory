                        ...
                        <nav class="sidenav-menu-nested nav accordion" id="accordionSidenavPagesMenu">
                            ...
                            <div class="collapse" id="pagesCollapseAccount" data-bs-parent="#accordionSidenavPagesMenu">
                                <nav class="sidenav-menu-nested nav">
                                    <a class="nav-link" href="account-profile.html">Machine Results</a>
                                    <a class="nav-link" href="account-profile.html">Supervisor Approval</a>
                                    <a class="nav-link" href="account-billing.html">Doctor Approval</a>
                                    ...
                                    <a class="nav-link" href="account-security.html">Rejected Sample</a>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-xl-8 col-xxl-12">
                                        <div class="text-center text-xl-start text-xxl-center mb-4 mb-xl-0 mb-xxl-4">
                                            <h1 class="text-primary">Welcome to Smart-Lab System!</h1>
                                            <p class="text-gray-700 mb-0">Browse our fully Lab UI toolkit! Browse our prebuilt app pages, components, and sections, and be sure to look at our full documentation!</p>
                                        </div>
                                    </div>
                                ...
                                <div class="timeline timeline-xs">
                                    ...
                                    <div class="timeline-item">
                                        ...
                                        <div class="timeline-item-content">
                                            New Sample placed!
                                            <a class="fw-bold text-dark" href="#!">sample #2912</a>
                                    ...
                                    <div class="timeline-item">
                                        ...
                                        <div class="timeline-item-content">
                                            New Sample placed!
                                            <a class="fw-bold text-dark" href="#!">Sample #2911</a>
                                            has been successfully placed.
                                        </div>
                                    </div>
                                    <!-- Timeline Item 6-->
                                    <div class="timeline-item">
                                        ...
                                        <div class="timeline-item-content">
                                            New Employee placed!
                                            <a class="fw-bold text-dark" href="#!">Employee #2911</a>
                                            has been successfully placed.
                                        </div>
                                    </div>
                                    <!-- Timeline Item 7-->
                                    <div class="timeline-item">
                                        ...
                                        <div class="timeline-item-content">
                                            New sample placed!
                                            <a class="fw-bold text-dark" href="#!">sample #2910</a>
                                            has been successfully placed.
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-6 col-xl-3 mb-4">
                        <div class="card bg-success text-white h-100">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="me-3">
                                        <div class="text-white-75 small">Machine Results </div>
                    ...
                    <div class="col-lg-6 col-xl-3 mb-4">
                        <div class="card bg-danger text-white h-100">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="me-3">
                                        <div class="text-white-75 small">Pending Samples</div>
